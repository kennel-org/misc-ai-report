...
# pulsar2 4.2 の Docker イメージ（AXERA 公式配布）をダウンロード
# 公式ドキュメントに記載されている URL を貼り付けてください。
# 例: https://download.axera-tech.com/pulsar2/ax_pulsar2_20250924_temp_40ca6580.tar.gz
PULSAR2_IMG_URL="<<ここに公式の URL をコピペ>>"

wget "$PULSAR2_IMG_URL" -O ax_pulsar2_20250924_temp_40ca6580.tar.gz
